package com.info.advanztest.dbfunctions;
...
public class LocationsContentProvider extends ContentProvider{
    ...
    public static final String PROVIDER_NAME = "advanz101test.locations";
    ...
    LocationDBHelper mLocationsDB;

    /** A callback method which is invoked when the content provider is starting up */
    @Override
    public boolean onCreate() {
        mLocationsDB = new LocationDBHelper(getContext());
        return true;
    }
